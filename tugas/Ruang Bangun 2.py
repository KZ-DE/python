...
# ============ fungsi csv=================
def save (bangun:str, x2, y2, kel, luas):
    waktu = time.asctime()
    with open("File.csv",mode='a', encoding='utf-8', newline='') as file:
        isi = waktu, bangun, xx1, yy1,x2, y2, kel, luas
        a = csv.writer(file)
        a.writerow(isi) 
    ...
    match selected_option.get(): 
        case "opsi 1":
            try:
                ...
                # file
                koordinatx2 = angka1 + xx1
                koordinaty2 = angka1 + yy1
                save("Persegi", koordinatx2, koordinaty2, kel, luas)
            except: 
        ...
        case "opsi 2":
            try:
                ...
                koordinatx2 = angka1 + xx1
                koordinaty2 = angka1 + yy1
                save("Persegi Panjang", koordinatx2, koordinaty2, kel, luas)
        ...
        case "opsi 3":
            try:
                ...
                koordinatx2 = angka1 + xx1
                koordinaty2 = angka1 + yy1
                save("Segitigas", koordinatx2, koordinaty2, kel, luas)
        ...
        case "opsi 4":
            try:
                ...
                koordinatx2 = angka1 + xx1
                koordinaty2 = angka1 + yy1
                save("Lingkaran", koordinatx2, koordinaty2, kel, luas)
            except: 
                hasil_l.config(text="Mohon masukan Bilangan")
def home ():
    ''' Home '''
...
try:
    ...
    with open("File.csv", mode="w", encoding="utf-8", newline="") as file:
        messagebox.showinfo("INFO", "Membuat File Baru")
        header = "Waktu", "Bangun Ruang", "X1", "Y1", "X2", "Y2", "Hasil Keliling", "Hasil Luas" 
        w = csv.writer(file)
        w.writerow(header)
